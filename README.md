...
This Stack has been replaced by [Stripe Stack](https://github.com/dev-xo/stripe-stack) which supports PostgreSQL and SQLite by default. We strongly recommend using it, and get the last updates.
